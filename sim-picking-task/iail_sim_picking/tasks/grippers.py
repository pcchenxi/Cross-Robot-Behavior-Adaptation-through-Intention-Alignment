...
class Suction(Gripper):
    ...
    def __init__(self, assets_root, robot, ee, obj_ids):
        ...
        # Load the compliant suction tip with both visuals and collision.
        ...
        p.changeConstraint(constraint_id, maxForce=200)
        ...
        # Default deformable-object parameters; tasks may override them.
        ...
        # State used when releasing a gripped deformable object.
        self.def_min_vetex = None
        self.def_min_distance = None

        # State used when releasing a rigid object that contacts deformables.
    ...
    def activate(self):
        ...
        if not self.activated:
            ...
            if points:
                ...
                # Attach the contacted rigid object to the suction tip.
                for point in points:
