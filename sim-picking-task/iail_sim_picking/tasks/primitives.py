...
class PickPlace():
    ...
    def __call__(self, movej, movep, ee, pose0, pose1=None):
        ...
        Args:
          ...
          pose1: unused legacy placing pose.
        ...
        # Move above the pick pose before descending.
        ...
        timeout, pre_pick_ee, pre_pick_joint = movep(prepick_pose, return_ee_info=True)
        ...
        while not ee.detect_contact():
            ...
            timeout, _, _ = movep(targ_pose, return_ee_info=True)
            if timeout:
                return True, pre_pick_ee, pre_pick_joint

        # Activate the gripper and retreat vertically.
        ee.activate()
        timeout |= movep(postpick_pose, self.speed)

        return timeout, pre_pick_ee, pre_pick_joint
